...
int main() {
  ...
  GaussLegendre gauss_legendre_2p{fun, two_points_w, two_points_alpha};

  std::cout << std::setprecision(10)
            << gauss_legendre_2p.CalculatePreciseIntegral(kPrecision, 0, 1)
            << '\n';
  ...
  GaussLegendre gauss_legendre_3p{fun, three_points_w, three_points_alpha};

  std::cout << gauss_legendre_3p.CalculatePreciseIntegral(kPrecision, 0, 1)
            << '\n';
  ...
  GaussLegendre gauss_legendre_4p{fun, four_points_w, four_points_alpha};

  std::cout << gauss_legendre_4p.CalculatePreciseIntegral(kPrecision, 0, 1)
            << '\n';
}
